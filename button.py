...
class Button():
    def __init__(self, pygame, win, onPressed=None, x=0, y=0, height=0, width=0, text = '', color=(255,255,255), textColor=(0, 0, 0)):
    ...
    def setText(self, text):
        self.text = self.myFont.render(text, False, self.textColor, self.color)
